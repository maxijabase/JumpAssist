...
public Action timerWelcomePlayer(Handle timer, int userid) {
  ...
  PrintWelcomeMessage(client, "\x01Welcome to\x079999FF %s", hostname);
  PrintWelcomeMessage(client, "\x01For help with\x03 JumpAssist\x01, type\x07FFA500 !ja_help");
  PrintWelcomeMessage(client, "\x01For server information, type\x07FFA500 !help");
  PrintWelcomeMessage(client, "\x03Be respectful to fellow jumpers");
  PrintWelcomeMessage(client, "\x03No trade chat");
  PrintWelcomeMessage(client, "\x03No complaining");
  PrintWelcomeMessage(client, "\x03No chat/voice spam");
